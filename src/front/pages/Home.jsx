...
import AlternativoFondo2 from "../assets/img/AlternativoFondo2.png";
...
export const Home = () => {
  ...
  // Inicializa y reproduce el audio UNA sola vez
  useEffect(() => {
    audioRef.current = new Audio(ParaHome);
    audioRef.current.volume = 0.1;
    audioRef.current.play();

    // Al desmontar, pausamos por seguridad
    return () => {
  ...
  const handleSignup = () => {
    audioRef.current.pause();          // ahora pausa la instancia correcta
    setAnimar(true);
  ...
  return (
    <div className="crack-container">
      {/* Capa inferior: imagen que queda oculta */}
      <div
        className="crack-layer bottom"
        style={{ backgroundImage: `url(${AlternativoFondo2})` }}
      />

      {/* Capa superior: tu fondo original */}
      <div
        className={`crack-layer top ${cracked ? "open" : ""}`}
      ...
      >
        <svg className="crack-svg" viewBox="0 0 100 100" preserveAspectRatio="none">
          <polyline
            ...
            points="100,0 100,100 0,100 20,90 20,80 30,60 40,60 70,50 80,30 80,20 90,20 100,0"
          />
        </svg>
        <div className="structure">
          {/* Al hacer hover sobre este h1 abrimos/cerramos la grieta */}
          <h1
            className="text_logo"
            onMouseEnter={() => setCracked(true)}
            onMouseLeave={() => setCracked(false)}
          >
            RACEGAME<span className="invertir">R</span>
          </h1>
          <div className="buttons">
            <div className="box">
              <div className="background-fill" />
              <div className="line main-line-left" />
              <div className="line main-line-right" />
              <div className="line vertical-left" />
              <div className="line vertical-right" />
              <div className="line top-line-left" />
              <div className="line top-line-right" />
              {/* Signup */}
              <div className="boxes container-fluid ">
                <svg width="250" className={animar ? 'blur-out-expand' : ''} onClick={handleSignup} height="50" viewBox="0 0 758 103" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="boxes container-fluid ">
                <svg width="250" className={animarA ? 'blur-out-expand' : ''} onClick={handleSignin} height="50" viewBox="0 0 680 103" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="boxes container-fluid">
                <svg onClick={handleVisitor} className={animarB ? 'blur-out-expand' : ''} width="250" height="50" viewBox="0 0 797 103" fill="none" xmlns="http://www.w3.org/2000/svg">
