...
Revision ID: 9a457fa34929
Revises: 0763d677d453
Create Date: 2025-05-21 20:02:00.486600
...
def upgrade():
    ...
    sa.Column('onlinegames_id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['onlinegames_id'], ['onlinegames.id'], ),
    sa.ForeignKeyConstraint(['user1_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['user2_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('user1_id', 'user2_id', 'onlinegames_id')
    )
